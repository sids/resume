...
\begin{category}{Selected Projects}
    ...
    \citem{Buddhi Online,} Ziva Software, Bangalore;
    {\teamsize 1}
    ...
    \citem{Buddhi,} Ziva Software, Bangalore;
    {\teamsize 2-3}
    ...
    \citem{Zook,} Ziva Software, Bangalore;
    {\teamsize 2-3}
    ...
    \citem{Zivabot,} Ziva Software, Bangalore;
    {\teamsize 1}
    ...
    \citem{yadb -- Yet Another DataBase,} IIIT, Bangalore;
    {\teamsize 3}
...
\begin{category}{Skills}
    ...
    \citem{Softwares/Frameworks:} Hadoop, Nutch, Lucene, Solr, Sphinx, WEKA,
...
\begin{category}{Honors}
    ...
    \citembullet {\em Valedictorian} for the class for 2006 at IIIT, Bangalore.
    {\period Jun 2006}
